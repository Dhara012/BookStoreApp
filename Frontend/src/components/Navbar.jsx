...
export default function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0  z-50 right-0 left-0${
                sticky?
                ...
                <div className="navbar ">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <a className="btn bg-black text-white px-5 py-2 rounded-md hover:bg-slate-700 duration-300" 
                        onClick={()=>
